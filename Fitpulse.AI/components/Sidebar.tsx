...
import { LayoutDashboard, Activity, Heart, Settings, LogOut, X, MessageSquare } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ className = '', onCloseMobile }) => {
  ...
  const navItems: NavItem[] = [
    ...
    { icon: Activity, label: 'Fitness', to: '/dashboard/fitness' },
    { icon: Heart, label: 'Health', to: '/dashboard/health' },
    { icon: MessageSquare, label: 'AI Assistant', to: '/dashboard/chat' },
