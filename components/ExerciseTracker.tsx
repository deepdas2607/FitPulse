        ...
        pose.onResults((results: any) => {
          ...
          if (results.poseLandmarks && POSE_CONNECTIONS) {
            ...
            if (isRecordingRef.current && !isPausedRef.current) {
              ...
              // Debug log
              console.log(`[TRACKER] Analysis repCount: ${analysis.repCount}, UI repCount: ${repCount}, State repCount: ${analysis.exerciseState.repCount}`);
              ...
              if (newRepCount > repCount) {
                ...
                // If rep count increased, add to current set
                if (newRepCount > currentSetReps.reduce((a, b) => a + b, 0)) {
                  const newReps = [...currentSetReps];
                  newReps[setCount] = (newReps[setCount] || 0) + 1;
