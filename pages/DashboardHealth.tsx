...
import { Scale, Activity, Target, ArrowUp, CheckCircle2, Camera, Bell } from 'lucide-react';
          ...
          <div className="max-w-7xl mx-auto space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <Card className="flex flex-col justify-between hover:shadow-md transition-shadow">
                ...
                <div>
                  <p className="text-slate-500 text-sm font-medium">Body Fat</p>
                  <h4 className="text-2xl font-bold text-slate-900 mt-1">
                    {userProfile?.bodyMetrics?.bodyFat || '--'} <span className="text-sm font-normal text-slate-400">%</span>
                  </h4>
                </div>
              </Card>
              ...
              <Card className="flex flex-col justify-between hover:shadow-md transition-shadow">
                ...
                <div>
                  <p className="text-slate-500 text-sm font-medium">Muscle Mass</p>
                  <h4 className="text-2xl font-bold text-slate-900 mt-1">
                    {userProfile?.bodyMetrics?.muscleMass || '--'} <span className="text-sm font-normal text-slate-400">kg</span>
                  </h4>
                </div>
              </Card>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2 space-y-6">
                <Card title="Sleep Quality Trend" className="h-[400px]">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between p-3 bg-slate-50 rounded-xl border border-slate-100">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="font-medium text-slate-700">Drink 2L Water</span>
                      </div>
                      <span className="text-xs font-bold text-slate-400">COMPLETED</span>
                    </div>
                    <div className="flex items-center justify-between p-3 bg-white rounded-xl border border-slate-100 hover:border-primary-200 transition-colors cursor-pointer group">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-full bg-slate-100 text-slate-400 group-hover:bg-primary-50 group-hover:text-primary-500 flex items-center justify-center transition-colors">
                          <Target className="w-5 h-5" />
                        </div>
                        <span className="font-medium text-slate-700">30 min Cardio</span>
                      </div>
                      <span className="text-xs font-bold text-primary-600 bg-primary-50 px-2 py-1 rounded">TODO</span>
                    </div>
                  </div>
                </Card>
              </div>
